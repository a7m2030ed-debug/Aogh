...
> **تنبيه: أرقام هذا التقرير مشوّهة، ولا تُقرأ وحدها.**
>
> سأل الفاحص عن ثلاثة وعشرين دوري متتابعةً بلا مهلة، فاستنفد معدّل
> المفتاح المجاني بنفسه. ولذلك تردّ أوّل أربعة دوريات بمباريات وتعود
> كل ما بعدها أصفاراً — والأصفار هنا **حدّ معدّل لا نقص تغطية**.
>
> القياس الصحيح في [`arab-fixtures-report.md`](arab-fixtures-report.md):
> دوريات أقلّ، ومهلة بينها، وإعادة محاولة عند الفراغ، وصفّ ضبط أوّلاً.
> ونتيجته أن **ثمانية من تسعة** دوريات عربية تردّ بمباريات حقيقية، وأن
> السقف الحقيقي مباراة واحدة لكل دوري — في العربية والإنجليزية سواء.
>
> ويبقى هذا الملف لفائدة واحدة: جدول «الدوريات المتاحة» بأسمائها
> ومعرّفاتها، وهو صحيح لأنه لا يعتمد على المعدّل.
