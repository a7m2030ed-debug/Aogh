...
هذه الصفحة لمن أراد فتح النظام **من خارج المجمع** — عبر الإنترنت على نطاق خاص. وحينها تلزم ثلاثة: خادم يعمل دائمًا، وشهادة https، ونسخ احتياطية خارج الخادم.

> **وإن كان الاستعمال داخل المجمع فقط فلا تحتاج شيئًا من هذا**: شغّل النظام على جهاز في العيادة وافتحه من بقية الأجهزة على الشبكة نفسها — [التشغيل بلا نطاق ولا استضافة](../../README.md#التشغيل-بلا-نطاق-ولا-استضافة).
